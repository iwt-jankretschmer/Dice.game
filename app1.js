var scores, roundScore, activePlayer, gamePlaying, numbere, lastThrow, lastThrowe, proof, sameSix, sameSixone;
init();
...
document.querySelector(".btn-roll").addEventListener("click", function () {
    if (gamePlaying) { //1.Random number
        ...
        var hello = function (stati, useddice, vari) {
            if (stati == 6 && useddice == 6) {
                vari = true;
            }
            else {
                vari = false;
